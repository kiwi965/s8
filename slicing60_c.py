...
output_folder = "C:/s7 60 rework/output_slices(coronal)"  # Base folder where all slices will be saved
...
for ct_scan_file, label_file in zip(ct_scan_files, label_files):
    ...
    for axis, axis_name in zip(range(3), ["coronal"]):  
...
print("\n Everything is hopefully done..c")