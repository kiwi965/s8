...
output_folder = "C:/s7 60 rework/output_slices(all with -1 after acs model creation)"  # Base folder where all slices will be saved

# Fracture label mappings
fracture_mapping = {
    -1:"fracture_but_cannot_be_determined",
